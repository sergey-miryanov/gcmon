...
The two polls in `captured_polls` are a verbatim capture from a CPython 3.15
target allocating in a loop, polled twice 100 ms apart. Hand-written batches tend
