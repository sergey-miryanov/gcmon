...
| 0068 | **Landed** 2026-09-09 (cleanup) | M | `cli` could import every layer, so an offline command could reach into the monitoring one and the layer test would pass. The tree is two towers over a shared base now, and the walk fails on the crossing. [ADR-0026](../docs/adr/0026-two-towers-over-a-shared-base.md) |
